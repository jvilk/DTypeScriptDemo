...
declare namespace ts {
    ...
    type RuntimeType = RuntimeAnyType | RuntimeNumericType | RuntimeNumericLiteralType | RuntimeStringType | RuntimeStringLiteralType | RuntimeBooleanType | RuntimeBooleanLiteralType | RuntimeVoidType | RuntimeNullType | RuntimeUnionType | RuntimeIntersectionType | RuntimeTypeParameterType | RuntimeObjectType | RuntimeNeverType;
    interface RuntimeIDBase {
        id: number;
    }
    interface RuntimeSignature extends RuntimeIDBase {
        args: RuntimeType[];
        varargs?: RuntimeType;
        result: RuntimeType;
        mandatoryArgs: number;
    }
    interface RuntimeAnyType extends RuntimeIDBase {
        type: TypeTag.Any;
    }
    interface RuntimeNeverType extends RuntimeIDBase {
        type: TypeTag.Never;
    }
    interface RuntimeNumericType extends RuntimeIDBase {
        type: TypeTag.Numeric;
    }
    interface RuntimeNumericLiteralType extends RuntimeIDBase {
        type: TypeTag.NumericLiteral;
        value: number;
    }
    interface RuntimeStringType extends RuntimeIDBase {
        type: TypeTag.String;
    }
    interface RuntimeStringLiteralType extends RuntimeIDBase {
        type: TypeTag.StringLiteral;
        value: string;
    }
    interface RuntimeBooleanType extends RuntimeIDBase {
        type: TypeTag.Boolean;
    }
    interface RuntimeBooleanLiteralType extends RuntimeIDBase {
        type: TypeTag.BooleanLiteral;
        value: boolean;
    }
    interface RuntimeVoidType extends RuntimeIDBase {
        type: TypeTag.Void;
    }
    interface RuntimeNullType extends RuntimeIDBase {
        type: TypeTag.Null;
    }
    interface RuntimeUnionType extends RuntimeIDBase {
        name?: string;
        type: TypeTag.Union;
        members: RuntimeType[];
    }
    interface RuntimeIntersectionType extends RuntimeIDBase {
        name?: string;
        type: TypeTag.Intersection;
        members: RuntimeType[];
    }
    interface RuntimeTypeParameterType extends RuntimeIDBase {
        type: TypeTag.TypeParameter;
        index: number;
    }
    interface RuntimeProperty extends RuntimeIDBase {
        optional: boolean;
        name: string;
        type: RuntimeType;
    }
    interface RuntimeObjectType extends RuntimeIDBase {
        name?: string;
        type: TypeTag.ObjectType;
        properties: {
            [name: string]: RuntimeProperty;
        };
